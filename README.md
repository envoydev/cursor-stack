...
| --------- | -------- | ----- |
| **Skills** (59) | `.cursor/skills/` | real copies; run as Cursor Skills (`agentskills.io`); includes `main-stack-agents-flow` per-domain orchestration + `cross-stack-agents-flow` cross-domain routing. `npx skills add … --agent cursor` |
