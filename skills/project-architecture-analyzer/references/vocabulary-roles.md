...
from memory loads nothing or the wrong thing. List what is installed first (`ls .cursor/skills`, plus any skill
your own skill list shows), then fill each role below from that listing, and put the chosen names in the
