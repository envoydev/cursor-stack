...
$Skills = @(
  ...
  'envoydev/cursor-stack|project-capabilities'           # deliberate capabilities capture - inventories installed skills/agents/MCPs/plugins, generates the awareness rule baseline-project-capabilities.mdc; manual /-only
