...
| --------- | -------- | ----- |
| **Skills** (54) | `.cursor/skills/` | real copies; run as Cursor Skills (`agentskills.io`); includes `domain-build` per-domain orchestration + `subagent-flow` cross-domain routing. `npx skills add … --agent cursor` |
